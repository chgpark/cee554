...
#FOR TEST
p.add_argument('--load_model_dir', type=str, default="/home/shapelim/RONet/test_karpe_1102/")
p.add_argument('--test_data', type=str, default='inputs/1103_Karpe_test2.csv')
# p.add_argument('--test_data', type=str, default='inputs/np_test_2.csv')
FILE_NAME = '1115_bimul'
###########
args = p.parse_args()
